...
export const ICONS = {
  ...
  store: '<path d="M5 8h14l-1 12H6z"/><path d="M9 8V6a3 3 0 0 1 6 0v2"/><path d="M9.5 12.5h5"/>',
  wallet: '<rect x="3" y="6" width="18" height="13" rx="3"/><path d="M3 10h18"/><circle cx="17" cy="14.5" r="1.4"/>',
  receipt: '<path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6"/><path d="M9 12h6"/>',
  globe: '<circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a14 14 0 0 1 0 18a14 14 0 0 1 0-18"/>',
  wifiOff: '<path d="M3 3l18 18"/><path d="M8.5 13.5a5 5 0 0 1 7 0"/><path d="M5 10a10 10 0 0 1 4-2.5"/><path d="M19 10a10 10 0 0 0-6.5-2.9"/><path d="M12 18h.01"/>',
